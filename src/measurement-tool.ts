...
export class MeasurementTool extends EventEmitter {
    ...
    addPointFromImage(imageXCoor: number, imageYCoor: number): void {
        ...
        let pixelInCamCoor = new Vector3();
        ...
        let rotationCamInWorld = new Matrix3();
        ...
        let direction = pixelInCamCoor.normalize();

        let camOrigin = new Vector3();
    ...
    private _updateHotspotInImage(hotspotPosition: Vector3){
        ...
        let posInHomogenWorldCoor = new Vector4(centeredHotspotPos.x,centeredHotspotPos.y,centeredHotspotPos.z,1);
        let posInHomogenCameraCoor =  posInHomogenWorldCoor.applyMatrix4(transformMat);

        let posInCameraCoor =  new Vector3(posInHomogenCameraCoor.x/posInHomogenCameraCoor.w, posInHomogenCameraCoor.y/posInHomogenCameraCoor.w,posInHomogenCameraCoor.z/posInHomogenCameraCoor.w);
        let xImageCoor = posInCameraCoor.x/posInCameraCoor.z*sensor.focalLengthInPx+sensor.cx;
        let yImageCoor = posInCameraCoor.y/posInCameraCoor.z*sensor.focalLengthInPx+sensor.cy;
