...
const icons: Record<string, string> = {
  doubleview: doubleviewIcon,
  "doubleview-mobile": doubleviewMobileIcon,
  singleview: singleViewIcon,
  "singleview-mobile": singleViewMobileIcon,
  "doubleview-synced": doubleviewSyncedIcon,
  "doubleview-synced-mobile": doubleviewSyncedMobileIcon,
  rotation: rotationIcon,
  measure: measurementIcon,
  environment3D: environment3dIcon,
};
